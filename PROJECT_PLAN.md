...
- [완료] Brachistochrone (미착수)
- [완료] Rigid Body Roller Coaster (2026-03-01)

5. [완료] 다물체/제약/체인

- [완료] Hanging Chain
- [완료] String (2026-03-01)
- [완료] Pile / Pile Attract
- [완료] Curved Objects (2026-03-01)

6. [완료] 고급 비교/검증 시뮬레이션

- [완료] Compare Double Pendulums
- [완료] Rigid Double Pendulum (2026-03-01)
...
- [완료] 전체 자동 테스트 114 PASS 기준으로 갱신 (2026-03-01)
...
- [완료] Wheel Joint: 서스펜션(Soft Constraint) 및 모터 구동 안정화 (2026-03-01 완료)
- [완료] Physics Sub-stepping: 가변 서브스텝(1/2/4/8) 옵션화 및 가이드 UI 반영 (2026-03-01 완료)
- [완료] Polygon CCD (Scaffold): 폴리곤 간 연속 충돌 처리 기초 루틴 구현 (2026-03-01 완료)
...
3. [완료] Rigid Body Roller Coaster (2026-03-01)
4. [완료] Colliding Blocks
5. [완료] Polygon Shapes (2026-03-01)
6. [완료] Curved Objects (2026-03-01)
7. [완료] String (2026-03-01)
8. [완료] Pendulum Clock (2026-03-01)
9. [미착수] Dangling Stick
10. [완료] Double Pendulum with Physics Engine
11. [완료] Cart + Pendulum with Physics Engine
12. [완료] Rigid Double Pendulum (2026-03-01)
...
### 5.6 Top 6 마감 기록 (2026-03-01)

- myPhysicsLab 비교 Top 6 구현 항목: 6/6 완료
- 상태 문서: `MYPHYSICSLAB_GAME_EXECUTION_PLAN.md`와 동기화
- 검증 기준:
  - `pnpm test` 107/107 PASS
  - `pnpm build` PASS
- 후속 우선순위:
  1. Curved Objects
  2. Rigid Body Roller Coaster
  3. String / Pendulum Clock / Dangling Stick / Rigid Double Pendulum
