...
6. [미착수] Phase 4: Advanced Mechanisms

- [완료] Joint Motor: revolute/slider 구동 및 제어 (1차 완료)
- [완료] Joint Limits: 각도/이동 범위 제한 및 충격 처리 (1차 완료)
- [완료] Prismatic Joint: 1차 직선 조립 구조 구현
- [미착수] Scene Editor: 바디/조인트 생성, 저장(JSON), 로드 기능 통합
