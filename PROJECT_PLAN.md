...
- [미착수] Colliding Blocks
- [완료] Newton's Cradle
- [미착수] Billiards
- [진행중] Rigid Body Collisions / Contact Forces (Collision Lab 기반)

4. [진행중] 트랙/경로 시스템
- [완료] Roller Coaster
- [미착수] Roller Coaster with Spring / Two Balls / Flight
- [미착수] Brachistochrone
...
- [미착수] Hanging Chain
- [미착수] String
- [미착수] Pile / Pile Attract
- [미착수] Curved Objects

6. [미착수] 고급 비교/검증 시뮬레이션
- [미착수] Compare Double Pendulums
- [미착수] Rigid Double Pendulum
- [미착수] Double Pendulum with Physics Engine
...
- 참고: Collision Lab 보드 크기 확장 필요(추가 게임/다물체 충돌 구현 전 우선 반영)

5. [진행중] 품질 강화
- [진행중] 수치 회귀 테스트(에너지/주기)
- [미착수] UI 접근성 점검(Web guidelines)
- [미착수] 플러그인 lifecycle 확장(onResize/onPause/onResume)
