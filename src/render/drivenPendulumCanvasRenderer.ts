...
export interface DrivenSceneMetrics {
  originX: number;
  originY: number;
  pixelsPerMeter: number;
}

export class DrivenPendulumCanvasRenderer {
  private readonly ctx: CanvasRenderingContext2D;

  constructor(private readonly canvas: HTMLCanvasElement, private readonly model: DrivenPendulum) {
  ...
  getSceneMetrics(): DrivenSceneMetrics {
